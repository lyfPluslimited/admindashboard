...
@Component({
  selector: 'app-specialist-posts',
  templateUrl: './specialist-posts.component.html',
  styleUrls: ['./specialist-posts.component.css']
})
export class SpecialistPostsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.postsService.getPosts().subscribe(res => {
      this.posts = res.filter(data => data.author != null && data.author.userRole == 2);
